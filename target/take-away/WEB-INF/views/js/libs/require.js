...
var requirejs, require, define; (function(ba) {
    ...
    function ga(b) {
        ...
        function d(a) {
            ...
            function(j) {
                if (j.getAttribute("data-requiremodule") === a && j.getAttribute("data-requirecontext") === h.contextName) return j.parentNode.removeChild(j),
                !0
            })
        }
        function p(a) {
            var j = n(k.paths, a);
            if (j && H(j) && 1 < j.length) return j.shift(),
            h.require.undef(a),
            h.makeRequire(null, {
                skipMap: !0
            })([a]),
        ...
        function i(a, j, b, f) {
            ...
            a = a[1];
            e && (e = c(e, i, f), d = n(q, e));
            a && (e ? m = d && d.normalize ? d.normalize(a,
            function(a) {
                return c(a, i, f)
        ...
        function D() {
            ...
            if (!W) {
                ...
                function(a) {
                    var h = a.map,
                    g = h.id;
                    if (a.enabled && (h.isDefine || l.push(a), !a.error)) if (!a.inited && c) p(g) ? e = b = !0 : (f.push(g), d(g));
        ...
        function I(a) {
            ...
            b = h.onScriptError; (!a.detachEvent || Y) && a.removeEventListener("error", b, !1);
            return {
                node: a,
            ...
            callPlugin: function() {
                ...
                function(f) {
                    ...
                    if (this.map.unnormalized) {
                        if (f.normalize && (g = f.normalize(g,
                        function(a) {
                            return c(a, P, !0)
                        }) || ""), f = i(a.prefix + "!" + g, this.map.parentMap), s(f, "defined", u(this,
                        function(a) {
                            this.init([],
                            function() {
                                return a
                    ...
                    } else d ? (this.map.url = h.nameToUrl(d), this.load()) : (l = u(this,
                    function(a) {
                        this.init([],
                        function() {
                            return a
                    ...
                    function(f, c) {
                        ...
                        try {
                            ...
                            return w(C("fromtexteval", "fromText eval for " + b + " failed: " + m, m, [b]))
                        }
                        P && (M = !0);
                        this.depMaps.push(g);
                        h.completeLoad(d);
            ...
            enable: function() {
                ...
                function(a, b) {
                    ...
                    if ("string" === typeof a) {
                        ...
                        this.errback ? s(a, "error", u(this, this.errback)) : this.events.error && s(a, "error", u(this,
                        function(a) {
                            this.emit("error", a)
                        }))
                    }
                    c = a.id;
                    f = m[c]; ! t(L, c) && (f && !f.enabled) && h.enable(a, this)
                }));
        ...
        h = {
            ...
            configure: function(a) {
                ...
                function(a) {
                    ...
                    k.pkgs[b] = a.name + "/" + (a.main || "main").replace(ia, "").replace(Q, "")
                });
                B(m,
                function(a, b) { ! a.inited && !a.map.unnormalized && (a.map = i(b, null, !0))
                });
            ...
            makeRequire: function(a, j) {
                function g(c, d, p) {
                    ...
                    if ("string" === typeof c) {
                        if (G(d)) return w(C("requireargs", "Invalid require call"), p);
                        if (a && t(L, c)) return L[c](m[a.id]);
                        if (e.get) return e.get(h, c, a, g);
                        k = i(c, a, !1, !0);
                        k = k.id;
                        return ! t(q, k) ? w(C("notloaded", 'Module name "' + k + '" has not been loaded yet for context: ' + b + (a ? "": ". Use require([])"))) : q[k]
                    }
                    J();
                    h.nextTick(function() {
                        J();
                ...
                U(g, {
                    ...
                    toUrl: function(b) {
                        ...
                        j = b.split("/")[0];
                        if ( - 1 !== e && (!("." === j || ".." === j) || 1 < e)) d = b.substring(e, b.length),
                        b = b.substring(0, e);
            ...
            completeLoad: function(a) {
                ...
                if (!b && !t(q, a) && c && !c.inited) {
                    if (k.enforceDefine && (!e || !da(e))) return p(a) ? void 0 : w(C("nodefine", "No define call for " + a, null, [a]));
                    E([a, d.deps || [], d.exportsFn])
                }
                D()
            },
            nameToUrl: function(a, b, c) {
                var d, g, i; (d = n(k.pkgs, a)) && (a = d);
            ...
            onScriptError: function(a) {
                var b = I(a);
                if (!p(b.id)) return w(C("scripterror", "Script error for: " + b.id, a, [b.id]))
            }
        };
        h.require = h.makeRequire();
        return h
    }
    var e, x, y, D, I, E, N, J, r, O, ka = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg,
    ...
    if ("undefined" === typeof define) {
        ...
        e = requirejs = function(b, c, d, p) {
            var g, i = "_"; ! H(b) && "string" !== typeof b && (g = b, H(c) ? (b = c, c = d, d = p) : b = []);
            g && g.context && (i = g.context); (p = n(F, i)) || (p = F[i] = e.s.newContext(i));
            g && p.configure(g);
        ...
        e.nextTick = "undefined" !== typeof setTimeout ?
        function(b) {
            setTimeout(b, 4)
        }: function(b) {
            b()
        ...
        function(b) {
            y || (y = b.parentNode);
            if (I = b.getAttribute("data-main")) return r = I,
            s.baseUrl || (E = r.split("/"), r = E.pop(), O = E.length ? E.join("/") + "/": "./", s.baseUrl = O),
            r = r.replace(Q, ""),
